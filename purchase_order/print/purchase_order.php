					...
					?>
						<div class="col-xs-6">
							<div class="form-group">
								...
								<div class="col-xs-10">
									<input type="text" class="form-control" name="" value="<?= $f['nama_supplier'] ?>">
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 col-form-label">ALamat</label>
								<div class="col-xs-10">
									<textarea name="" class="form-control" rows="3"><?= $f['alamat_supplier'] ?></textarea>
								</div>
							</div>
							<div class="form-group">
						...
						<div class="col-xs-6">
							...
							<div class="form-group">
								<label class="col-xs-2 col-form-label">Kota</label>
								<div class="col-xs-4">
									<input type="text" class="form-control" name="" value="<?= $kota ?>">
								</div>
								<label class="col-xs-2 col-form-label">Telepon</label>
								<div class="col-xs-4">
									<input type="text" class="form-control" name="" value="<?= $f['telepon'] ?>">
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-2 col-form-label">Kodepos</label>
								<div class="col-xs-4">
									<input type="text" class="form-control" name="" value="<?= $f['kodepos'] ?>">
								</div>
								<label class="col-xs-2 col-form-label">Handphone</label>
								<div class="col-xs-4">
									<input type="text" class="form-control" name="" value="<?= $f['handphone'] ?>">
								</div>
							</div>
						</div>
					<?php $i++; ?>
