...
--
-- Table structure for table `diskon_barang_reject_item`
--

CREATE TABLE `diskon_barang_reject_item` (
  `id` int(11) NOT NULL,
...
('Pick-002', 'Order-001', 'CST-001', 'Proses', '6', '2019-10-23', '2019-10-12 13:44:38', '2019-10-15 00:45:14'),
...
--
-- Indexes for table `diskon_barang_reject_item`
--
ALTER TABLE `diskon_barang_reject_item`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `diskon_barang_reject_item`
--
ALTER TABLE `diskon_barang_reject_item`
