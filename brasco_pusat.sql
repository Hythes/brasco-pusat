...
--
CREATE DATABASE
IF NOT EXISTS `brasco_pusat` DEFAULT CHARACTER
SET latin1
...
kode`,
`nama
`, `alamat`, `kota`, `kodepos`, `telepon`, `handphone`, `npwp`, `ktp`, `tipe_customer`, `kredit`, `contact_name`, `email`, `kode_sales`, `top`, `batas_kredit`, `tanggal_jual_akhir`, `saldo_awal`, `saldo_jalan`, `keterangan`, `created_at`, `updated_at`) VALUES
...
(255) DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp
(),
  `update_at` timestamp NULL DEFAULT NULL ON
UPDATE current_timestamp()
) ENGINE
=InnoDB DEFAULT CHARSET=latin1;
...
id`,
`barcode
`, `nama_barang`, `satuan`, `id_tipe_barang`, `harga_jual1`, `harga_jual2`, `harga_jual3`, `quantity`, `created_at`, `update_at`) VALUES
...
INSERT INTO `order_gudang` (`
nomor_order`,
`tanggal
`, `nomor_so`, `kode_customer`, `keterangan`, `total`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `order_gudang_item` (`
id`,
`nomor_order
`, `barcode`, `quantity`, `created_at`, `updated_at`) VALUES
...
id`,
`kode
`, `tanggal`, `nama`, `alamat`, `kota`, `kodepos`, `no_telepon`, `no_handphone`) VALUES
...
INSERT INTO `pengajuan_perubahan_harga` (`
nomor_pengajuan`,
`tipe_customer
`, `tanggal_approve`, `tanggal_pengajuan`, `keterangan`, `status`, `created_at`, `updated_at`) VALUES
...
(255) NOT NULL,
  `harga_jual_lama` varchar
(255) NOT NULL,
  `harga_jual_baru` varchar
(255) NOT NULL,
  `quantity` varchar
(255) NOT NULL,
  `keterangan` text NOT NULL,
...
INSERT INTO `pph_item` (`
nomor_pengajuan`,
`tanggal
`, `tipe_customer`, `barcode_inventory`, `harga_jual_lama`, `harga_jual_baru`, `quantity`, `keterangan`, `created_at`, `updated_at`) VALUES
...
id`,
`kode_cabang
`, `nama_cabang`, `alamat`, `alamat2`, `kota`, `kodepos`, `no_telp`, `no_hp`, `chief`, `logo`) VALUES
...
(255) NOT NULL,
  `tipe_ppn` varchar
(2) DEFAULT NULL,
  `tipe_ppn_input` varchar
(255) NOT NULL,
  `total_harga` varchar
(255) NOT NULL,
  `keterangan` varchar
(255) NOT NULL,
  `keterangan_approve` varchar
(255) DEFAULT NULL,
  `status` varchar
(255) DEFAULT 'Belum Approve',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp
(),
  `updated_at` timestamp NULL DEFAULT NULL ON
UPDATE current_timestamp()
...
kode`,
`tanggal
`, `tanggal_approve`, `kode_supplier`, `nama_supplier`, `alamat_supplier`, `nama`, `alamat`, `kota`, `kodepos`, `telepon`, `handphone`, `dpp`, `tipe_ppn`, `tipe_ppn_input`, `total_harga`, `keterangan`, `keterangan_approve`, `status`, `created_at`, `updated_at`) VALUES
...
(255) NOT NULL,
  `barcode_inventory` varchar
(255) NOT NULL,
  `kode_item_supplier` varchar
(255) DEFAULT NULL,
  `nama_inventory` varchar
(255) NOT NULL,
  `quantity` varchar
(255) NOT NULL,
  `harga_satuan` varchar
(255) NOT NULL,
  `satuan` varchar
(255) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp
...
id`,
`kode_po
`, `barcode_inventory`, `kode_item_supplier`, `nama_inventory`, `quantity`, `harga_satuan`, `satuan`, `created_at`, `updated_at`) VALUES
...
(255) NOT NULL,
  `barcode` varchar
(255) NOT NULL,
  `quantity_order` varchar
(255) NOT NULL,
  `quantity_terima` varchar
(255) NOT NULL,
  `harga_satuan` varchar
(255) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp
...
nomor_so`,
`tanggal_so
`, `kode_customer`, `keterangan`, `total`, `created_at`, `updated_at`) VALUES
...
kode`,
`nama
`, `alamat`, `kota`, `kodepos`, `telepon`, `fax`, `handphone`, `contact_name`, `email`, `kredit`, `top`, `pkp`, `created_at`, `updated_at`) VALUES
...
ALTER TABLE `profil`
  MODIFY `id` int
(60) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
